 ...
 */
export const formatFeedbackResponse = (feedback) => {
    const response = {
        id: feedback.id,
 ...
 */
export const createFeedback = async (studentId, data) => {
 ...
 */
export const getFeedbackByStudentAndCourse = async (studentId, courseId) => {
 ...
 */
export const updateFeedback = async (studentId, courseId, data) => {
 ...
 * Delete feedback
 */
export const deleteFeedback = async (studentId, courseId) => {
    // Check if feedback exists
    const existingFeedback = await prisma.feedback.findUnique({
        where: {
            studentId_courseId: {
