      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center gap-12 lg:flex-row lg:items-start">
        ...
        <div className="w-full space-y-8 lg:w-1/2">
          ...
          <div className="flex gap-4">
            ...
            <button className="group rounded-xl border border-white/10 bg-zinc-900 px-6 py-4 text-white transition-colors hover:border-red-500/50">
              <svg
                className="h-6 w-6 transition-colors group-hover:text-red-500"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
